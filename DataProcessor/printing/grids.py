...
def grid_psd(text):
    ...
    plt.figtext(0.08, 0.95, text, fontsize=20)
    gs1 = GridSpec(2, 2)
    gs1.update(left=0.04, right=0.47, bottom=0.54, hspace=0.25)
    ...
    gs1_ax = [gs1_ax1, gs1_ax2, gs1_ax3, gs1_ax4]

    gs2 = GridSpec(2, 2)
    gs2.update(left=0.53, right=0.98, bottom=0.54, hspace=0.25)
    ...
    gs3 = GridSpec(2, 2)
    gs3.update(left=0.04, right=0.47, top=0.46, hspace=0.25)
    ...
    gs4 = GridSpec(2, 2)
    gs4.update(left=0.53, right=0.98, top=0.46, hspace=0.25)

    gs4_ax1 = plt.subplot(gs4[0, 0])
    gs4_ax2 = plt.subplot(gs4[0, 1])
    gs4_ax3 = plt.subplot(gs4[1, 0])
    gs4_ax4 = plt.subplot(gs4[1, 1])

    gs4_ax = [gs4_ax1, gs4_ax2, gs4_ax3, gs4_ax4]
